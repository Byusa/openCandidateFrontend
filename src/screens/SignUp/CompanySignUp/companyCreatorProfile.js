...
class CompanyCreaterProfile extends Component<{}> {
  constructor(props) {
    super(props);
    this.state = {
      firstName: "",
    ...
    if (firstName && lastName && email && password && confirmPass) {
      if (password.localeCompare(confirmPass) === 0) {
        this.props.createUser(
          ...
          email,
          phone,
          this.props.create_profile.city,
        ...
        <View style={styles.formView}>
          ...
          <View>
            <View style={{ marginTop: 30 }}>
              <NextButton onPress={this.createUser} btnTxt={"Next"} />
            </View>
          </View>
        </View>
      </View>
...
export default connect(mapStateToProps, actions)(CompanyCreaterProfile);
